...
@foreach ($pharmaci as $pharmacies)
@if ($pharmacies->expire ==1)

<div class="card text-left">
  <img class="card-img-top" src="holder.js/100px180/" alt="">
  <div class="card-body">
    <h4 class="card-title">{{ $pharmacies->medicament_name }}</h4>
    <p class="card-text"> <h1>انتهاء تاريخ هذا الدواء</h1></p>
  </div>
</div>
