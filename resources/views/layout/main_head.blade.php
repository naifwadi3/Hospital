<div id="kt_app_header" class="app-header" dir="rtl" >
    <!--begin::Header container-->
    <div  class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        <!--begin::sidebar mobile toggle-->
        <div class="d-flex align-items-center d-lg-none ms-n2 me-2" title="Show sidebar menu" dir="rtl">
            <div class="btn btn-icon btn-active-color-primary w-35px h-35px" id="kt_app_sidebar_mobile_toggle" dir="rtl">
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            ...
                                                            <a href="../../demo1/dist/pages/user-profile/overview.html" class="menu-link">
                                                                <span class="menu-title">بثب</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
